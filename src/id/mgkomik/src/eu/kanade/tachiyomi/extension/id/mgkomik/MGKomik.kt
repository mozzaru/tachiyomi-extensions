...
if (responseBody?.contains("Cloudflare") == true) {
    ...
    // Ekstrak informasi dari form tantangan
}
...
object CloudflareBypasser {
    ...
    fun main(args: Array<String>) {
        val headers = Headers.Builder()
            .add("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.82 Safari/537.36")
