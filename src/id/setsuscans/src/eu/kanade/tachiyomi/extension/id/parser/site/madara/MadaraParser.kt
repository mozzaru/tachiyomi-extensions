package eu.kanade.tachiyomi.extension.id.parser.site.madara
...
import eu.kanade.tachiyomi.extension.id.parser.MangaParserAuthProvider
import eu.kanade.tachiyomi.extension.id.parser.config.ConfigKey
import eu.kanade.tachiyomi.extension.id.parser.core.LegacyPagedMangaParser
import eu.kanade.tachiyomi.extension.id.parser.exception.AuthRequiredException
import eu.kanade.tachiyomi.extension.id.parser.exception.ParseException
import eu.kanade.tachiyomi.extension.id.parser.model.*
import eu.kanade.tachiyomi.extension.id.parser.util.*
