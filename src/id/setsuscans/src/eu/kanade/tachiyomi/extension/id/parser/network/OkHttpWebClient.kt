package eu.kanade.tachiyomi.extension.id.parser.network
...
import eu.kanade.tachiyomi.extension.id.parser.exception.GraphQLException
import eu.kanade.tachiyomi.extension.id.parser.exception.NotFoundException
import eu.kanade.tachiyomi.extension.id.parser.model.MangaSource
import eu.kanade.tachiyomi.extension.id.parser.util.await
import eu.kanade.tachiyomi.extension.id.parser.util.parseJson
